...
export const ServerHeader = ({
    ...
    return (
        <DropdownMenu >
            ...
            <DropdownMenuContent
                className="w-56 text-xs font-medium text-black dark:text-neutral-400 spacy-y-[2px]"
            >

                {isModerator && 
                    <DropdownMenuItem
                        onClick={() => onOpen("invite", { server })}
                        className="text-indigo-600 dark:text-indigo-500 px-3 py-2 text0-sm cursor-pointer"
                    >
                        Invite People
                ...
                {isAdmin && 
                    <DropdownMenuItem
                        ...
                        className="px-3 py-2 text0-sm cursor-pointer"
                    >
                        Server Settings
                ...
                {isAdmin && 
                    <DropdownMenuItem
                        ...
                        className="text-rose-500 px-3 py-2 text0-sm cursor-pointer"
                    >
                        Delete Server
